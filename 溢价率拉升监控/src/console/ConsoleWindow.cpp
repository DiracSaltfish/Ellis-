...
void ConsoleWindow::startAdapter()
{
    ...
    QStringList arguments{QDir(root_).filePath(QStringLiteral("adapter/tgw_adapter.py")),
                          QStringLiteral("--socket"), QDir(root_).filePath(app.value(QStringLiteral("adapter_socket")).toString(QStringLiteral("runtime/tgw.sock"))),
                          ...
                          QStringLiteral("--log"), QDir(root_).filePath(QStringLiteral("logs/tgw-adapter.log"))};
    const QString account = QDir(root_).filePath(QStringLiteral("config/tgw_account.ini"));
    if (app.value(QStringLiteral("mode")).toString() == QStringLiteral("simulation") || !QFileInfo::exists(account)) {
    ...
    adapter_.start(python, arguments);
}
