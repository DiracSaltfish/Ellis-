...
expected_old='c0ef2751d558b76afcc9a671f975468cb820fadb647a26342200eaef778134b3'
...
backup=root/'backups'/time.strftime('netting-20260916-%H%M%S');backup.mkdir(parents=True)
