# Machome 五合一 v1.1.0：本地 IOPV 与 L1 保留版

本目录是复制后的新版开发目录，合并说明与验收边界见 [合并与验收](docs/v1.1.0/合并与验收.md)。下方为继承的原版说明，原历史测试结果不代表新版验收。
...
本次交付已于 2026-09-07 完成 Machome 部署；内网端点 `192.168.1.113:18976`。验收记录位于监控项目 `analysis/v24_sync_validation/验证记录.md`，包含 142/38/18 项测试、实际内网往返及回退位置。
