...
SecurityName=证券名称
Quantity=证券数量
CashSubstitute=现金替代标志
PremiumRatio=替代溢价比例
CreationCashSubstitute=申购现金替代
RedemptionCashSubstitute=赎回现金替代
CashSubstituteAmount=现金替代金额
TradingDay=交易日期
...
QString styleSheet() {
    return QStringLiteral(R"(
        ...
        QPushButton:checked { background: #dceef4; color: #145c73; border-color: #28768b; font-weight: 600; }
        ...
        QTableView, QTableWidget, QTreeWidget { background: white; alternate-background-color: #f7f9fc; border: 1px solid #dfe7ef; gridline-color: #eef2f7; selection-background-color: #e2f0f7; selection-color: #173b55; }
        QTableView::item, QTableWidget::item, QTreeWidget::item { padding: 5px; }
