...
public:
    ...
    void process(const BridgeFrame &frame, const QDateTime &now, bool allow30, bool allow300,
                 ...
                 bool localEnabled=false, const QJsonObject &valuation={}, const QString &basis="midpoint");
...
private:
    QHash<QString, QString> localKeys_;
...
private:
    ...
    QJsonObject localMessage(QJsonObject object) const;
    ...
    QNetworkAccessManager *iopvNetwork_ = nullptr;
    QTimer iopvPoll_;
    bool iopvPolling_ = false;
    QHash<QString,QJsonObject> localValuations_;
    QSet<QWebSocket *> localSignalClients_;
    QString configPath_;
