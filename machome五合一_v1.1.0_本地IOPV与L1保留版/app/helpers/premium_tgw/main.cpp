#include "helpers/premium_tgw/NativeTgwAdapter.h"
...
int main(int argc, char **argv)
{
    ...
    QCoreApplication::setApplicationName(QStringLiteral("machome-premium-tgw-helper"));
    ...
    machome::premium::tgw_helper::AdapterOptions options;
    ...
    machome::premium::tgw_helper::NativeTgwAdapter adapter(std::move(options));
    QString error;
