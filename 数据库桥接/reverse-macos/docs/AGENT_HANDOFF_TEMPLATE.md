...
```text
工作目录：/Users/ellis/工具程序开发/数据库桥接

你只负责 <接口名 + 明确子范围>，不要顺手实现其它接口。

开始前完整阅读：
1. reverse-macos/docs/AGENT_PARITY_WORKFLOW.md
2. reverse-macos/docs/PDF_API_PARITY_MATRIX.md 中对应行
3. 两份 PDF 的对应完整页面
4. V1.0.8 发行包中对应头文件
...
7. 新建 reverse-macos/docs/evidence/<接口小写>.md，使用工作流规定的固定格式。
