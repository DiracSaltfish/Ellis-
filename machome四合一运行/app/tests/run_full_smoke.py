...
def main() -> int:
    ...
    try:
        ...
        assert hello.get("version") == "1.0.0", hello
        ...
        upload_ready, upload_observed = wait_for(
            ...
            and m.get("payload", {}).get("telemetry", {}).get("worker_count") == 2,
            6,
        )
        ...
        command(client, revisions, "webull", "webull_set_mode", {"mode": "force_running"})
