...
private:
    ...
    QJsonObject uploadWorkerJson(const machome::bridge::UploadWorkerStatus &worker) const;
    ...
    machome::bridge::UploadClient *upload_ = nullptr;
    machome::premium::PremiumClient *premium_ = nullptr;
    WebullClient *webull_ = nullptr;
