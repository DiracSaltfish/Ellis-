...
更新时间：2026-08-30；实现版本：`1.0.9.2.macos.re7`。
...
| `QueryKline` | SZSE `159691` 1 分钟 `10000`（仅 2026-08-26 09:00–15:00，`normalized=True` 可给出经核验的元/股/元单位）；SSE `510300` 日线 `10008`、周线 `10009`、月线 `10010`、季线 `10011` 与年线 `10012`，同步返回 | `LIVE_ALIGNED(159691 one-minute sample + daily + weekly + monthly + quarterly + yearly)` | 仅已验证子范围可低频试点；3 分钟 `10001` 仅完成静态三方契约，Linux 账号在登录阶段因 `-95` 数据权限被拒且未发出查询，Mac 仍显式拒绝 |
