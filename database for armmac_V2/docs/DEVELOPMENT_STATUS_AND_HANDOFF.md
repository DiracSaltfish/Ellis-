...
更新时间：2026-09-09；当前实现：`1.0.9.2.macos.re8`。
...
- 1 分钟 K 线：SZSE `159691`、`10000→10000`，特定 2026-08-26 样本已核验单位；
  2026-09-09 新增 HKEx/港股 `00001`/`00177`/`00187`/`00200`/`00300`/`00700`
  （market=103）与 A 股 `000001.SZ`/`600000.SH`（market=102/101）的 1 分钟 `10000`
  样本（2026-09-07..09），与 Linux 官方 SDK 同参数**逐行摘要一致**
  （evidence `query_kline_hk_hkex_minute_20260909`）；
