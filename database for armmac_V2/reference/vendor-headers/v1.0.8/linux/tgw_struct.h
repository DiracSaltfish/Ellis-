...
struct MDSnapshotL2
{
    ...
    int64_t etf_buy_amount;                                        // ETF 申购数量
    int64_t etf_buy_money;                                         // ETF 申购金额
    int64_t etf_sell_number;                                       // ETF 赎回笔数
    int64_t etf_sell_amount;                                       // ETF 赎回数量
    int64_t etf_sell_money;                                        // ETF 申购金额
};
...
struct MDTickOrder
{
    ...
    int64_t biz_index;                                      // 业务序号
    int64_t traded_order_volume;                            // 已成交委托数量
};
...
struct ReqHQFactor
{
    ...
    std::vector<SecurityInfo> security_list;
};
